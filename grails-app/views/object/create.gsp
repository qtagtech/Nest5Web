...
<html>
	...
	<body>
		<a href="#create-object" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-object" class="content scaffold-create" role="main">
