                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" id="form-ingredient-category" action="nada.html" role="form" >     %{--The sames js is used here as the one used for savig and ingredient category row--}%
