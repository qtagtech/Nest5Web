                          ...
                          +'<div class="txt">'
                             +'<div class="row">'
                                +'<div class="col-lg-6"><label for="mult_initials">Iniciales </label></div>'
                                  +'<div class="col-lg-6">'
                                      +'<input type="text" id="mult_initials" name="mult_initials" value="'+val.trim()+'" disabled="disabled">'
                                      +'<span class="help-block blue">E.g. ml</span>'
                                  +'</div>'
                              +'</div>'
                              +'<div class="row">'
                                 ...
                                 +'<div class="col-lg-6">'
                                 +'<input type="text" id="mult_value" value="1" name="mult_value">'
                 ...
                 var html = '<li class="clearfix">'
                          +'<div class="txt">'
                             +'<div class="row">'
                                +'<div class="col-lg-6"><label for="mult_initials">Iniciales </label></div>'
                                  +'<div class="col-lg-6">'
                                      +'<input type="text" id="mult_initials" name="mult_initials" value="" >'
                                      +'<span class="help-block blue">E.g. ml</span>'
                                  +'</div>'
                              +'</div>'
                              +'<div class="row">'
                                 +'<div class="col-lg-6"><label for="mult_value">Valor(Solo el n&uacute;mero)</label></div>'
                                 +'<div class="col-lg-6">'
                                 +'<input type="text" id="mult_value" value="" name="mult_value">'
                                 +'<span class="help-block blue">E.g. 1000(ml)</span>'
                                  +'</div>'
                                 +'</div>'
                                 +'</div>'
