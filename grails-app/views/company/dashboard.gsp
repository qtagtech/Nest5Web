...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <!--[if lt IE 9]>
      <script type="text/javascript" src="${resource(dir:'dashboard/js/libs',file: 'excanvas.min.js')}"></script>
      <script type="text/javascript" src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
      <script type="text/javascript" src="${resource(dir:'dashboard/js/libs',file: 'respond.min.js')}"></script>
    <![endif]-->
    ...
    <script type="text/javascript" src="${resource(dir:'dashboard/js/libs',file: 'modernizr.js')}"></script>
                ...
                <ul class="nav navbar-right usernav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown">
                            <img src="${resource(dir:'dashboard/images',file: 'avatar.jpg')}" alt="" class="image" />
    ...
    <script type="text/javascript" src="${resource(dir:'dashboard/js/bootstrap',file: 'bootstrap.js')}"></script>
    <script type="text/javascript" src="${resource(dir:'dashboard/js/',file: 'jquery.mousewheel.js')}"></script>
    ...
    <script type="text/javascript" src="${resource(dir:'dashboard/js',file:'dashboard.js')}"></script><!-- Init plugins only for page -->
