                                            ...
                                            <tr class="<g:if test="${i % 2 == 0}">even</g:if><g:else>odd</g:else> gradeX <g:if test="${element?.fields?.cost / (element?.fields?.price != "NaN" ? element?.fields?.price : 1) >=1}">success</g:if>">
                                                ...
                                                <td>
                                                    <div class="controls center">
                                                        <a href="${createLink(controller: 'company',action: 'editCombo',params: [id: element?.syncId])}" class="tip" oldtitle="Editar" title="" data-hasqtip="true" aria-describedby="qtip-13"><span class="icon12 icomoon-icon-pencil"></span></a>
