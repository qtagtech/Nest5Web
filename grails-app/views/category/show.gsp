	...
	<body>
		...
		<div id="show-category" class="content scaffold-show" role="main">
			...
			<ol class="property-list category">
				...
				<g:if test="${categoryInstance?.families}">
				<li class="fieldcontain">
					<span id="families-label" class="property-label"><g:message code="category.families.label" default="Families" /></span>
					
						<g:each in="${categoryInstance.families}" var="f">
				...
				<g:if test="${categoryInstance?.icon}">
				<li class="fieldcontain">
					<span id="icon-label" class="property-label"><g:message code="category.icon.label" default="Icon" /></span>
					
						<span class="property-value" aria-labelledby="icon-label"><g:link controller="icon" action="show" id="${categoryInstance?.icon?.id}">${categoryInstance?.icon?.encodeAsHTML()}</g:link></span>
