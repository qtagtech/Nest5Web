	...
	<body>
		...
		<div id="show-eventType" class="content scaffold-show" role="main">
			...
			<ol class="property-list eventType">
				...
				<g:if test="${eventTypeInstance?.message}">
				<li class="fieldcontain">
					<span id="message-label" class="property-label"><g:message code="eventType.message.label" default="Message" /></span>
					
						<span class="property-value" aria-labelledby="message-label"><g:fieldValue bean="${eventTypeInstance}" field="message"/></span>
				...
				<g:if test="${eventTypeInstance?.ownMessage}">
				<li class="fieldcontain">
					<span id="ownMessage-label" class="property-label"><g:message code="eventType.ownMessage.label" default="Own Message" /></span>
					
						<span class="property-value" aria-labelledby="ownMessage-label"><g:fieldValue bean="${eventTypeInstance}" field="ownMessage"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${eventTypeInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
