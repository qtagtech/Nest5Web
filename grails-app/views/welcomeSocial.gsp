                            ...
                            <tr>
                                <td style="padding: 0px 0 25px;"  valign="top">
                                    <p style="color:#000; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 14px;font-family: Verdana, 'Monaco', monospace; ">
                                        Ya te has registrado. De ahora en adelante con solo haber iniciado sesión en ${accountType}, podrás cumplir retos en <strong>La Experiencia Nest5</strong><br>
                                        También puedes ingresar usando tu email: ${user.email} y la contraseña que escojas en esta página:<br>
                                        <a href="${link}" style="color: #0fa2e6; text-decoration: none;">${link}</a><br>
