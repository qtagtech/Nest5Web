...
<head>
    ...
    <meta charset="utf-8">
    <!-- site title -->
    <title>Nest5 - ¡${invite.user} te ha invitado a hacer parte!</title>
...
<header id="top">
    <div class="container">
        <div class="row">
            <div class="span12">
                <h1 id="logo"><a href="${createLink(uri: '/')}">
                    <span class="logo-fontcon icon-magic"></span>
                    <img src="https://s3-us-west-2.amazonaws.com/com.nest5.assets/user-profile/letras_nest5_low.png" alt="Nest5"></a>
                </h1>
                <div id="navigation">
                    <ul class="menu hidden-phone">
                        <li><a class="smoothscroll" href="#features">¿Cómo funciona?</a></li>
                        <li><a class="smoothscroll" href="#findanswers">Preguntas Frecuentas</a></li>
                    </ul>
                    <form name="nav" class="hidden-desktop hidden-tablet">
        ...
        <div class="row">
            <div class="span12">
                <div class="teaser-left">
                    ...
                    <h3>Te ha escogido como uno de sus 10 Invitados a Nest5.</h3>
                    <ul class="superlist">
                        <li>
                            <span class="title">Obtén una Tarjeta de Sellos Virtual</span>
                            <span class="subtitle">La usas en tus Marcas favoritas, cada 5 sellos, éstas de obsequian un beneficio.</span>
                        </li>
                        <li>
                            <span class="title">Descubre Marcas Cercanas a tu corazón</span>
                            <span class="subtitle">En tiempo real sabrás que Marcas están cerca y lo que te ofrecen para saber si te interesan.</span>
                        </li>
                        <li>
                            <span class="title">Sigue tus amigos</span>
                            <span class="subtitle">Aprende que les gusta, mantente pendiente de que Marcas frecuentan y conoce gente que se comporte parecido a ti con las Marcas y las compras.</span>
                        </li>
                        <li>
                            <span class="title">Inscríbete Ya, y te damos un obsequio</span>
                            <span class="subtitle">Por ser invitado a Nest5, tu amigo ${invite?.user?.name.split(" ")[0]} y tú recibirán un obsequio de nuestra parte.</span>
                        </li>
                    </ul>
                    <h5>También tenemos una App móvil para que desde cualquier lugar sigas tus Marcas, tus Amigos y sepas que hay cerca que te enamore</h5>
                    %{--<div class="store-buttons">
                        <a href="#"><img src="images/appstore.png" alt="App Store"></a>
                    </div>--}%
                    <div class="store-buttons">
                        <a href="https://play.google.com/store/apps/details?id=com.nest5.androidClient" target="_blank"><img src="${resource(dir: 'landing/images', file:'googleplay.png')}" alt="GooglePlay"></a>
                    </div>
                </div>
                <div class="teaser-right">
                    <div id="calltoaction-form" class="teaser-form">
                        <div id="form-title" class="form-title">
                            <h3>¡Inscríbete Ya!</h3>
                            <p class="callus">Así, ${invite?.user?.name.split(" ")[0]} y tú recibirán un obsequio que les enviaremos</p>
                        </div>
                        <form id="register-form" action="#" method="post">
                            ...
                            <div class="form-section">
                                ...
                                <input id="email" name="email" type="text" placeholder="Dirección de Email" value="${invite?.email}">
                            </div>
                            <div class="form-section">
        ...
        <div class="row">
            <div class="span12">
                <ul class="social-icons">
                    <li><a href="http://www.facebook.com/Nest5Oficial" target="_blank" data-toggle="tooltip" title="Visita nuestra página de facebook"><img src="${resource(dir: 'landing/images/icons/social', file: 'facebook.png')}" alt="Facebook" class="social-icon"></a></li>
                    <li><a href="hhtp://www.twitter.com/Nest5_Oficial" target="_blank" data-toggle="tooltip" title="Síguenos en Twitter"><img src="${resource(dir: 'landing/images/icons/social', file: 'twitter.png')}" alt="Twitter" class="social-icon"></a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="span12">
                ...
                <div id="faqholder">
                    <dl>
                        <dt><span class="colored">Q</span> <p>¿Para qué sirve Nest5?</p></dt>
                        <dd>
                        ...
                        <dt><span class="colored">Q</span><p>¿Cuánto Cuesta usar Nest5?</p></dt>
                        <dd>
                            <p>Nest5 es COMPLETAMENTE GRATIS. Nunca tendrás que pagar nada por convertir tu vida de compras en social. </p>
                        </dd>
                        <dt><span class="colored">Q</span><p>¿Como protegen mi información?</p></dt>
                        <dd>
                        ...
                        <dt><span class="colored">Q</span> <p>¿Cómo me dan el regalo por inscribirme?</p></dt>
                        <dd>
                            <p>Una vez termines el registro, tendrás la posibilidad de indicar una dirección física, en donde en el transcurso de un mes te enviaremos tu obsequio Nest5.</p>
                        </dd>
                        <dt><span class="colored">Q</span> <p>¿Yo puedo invitar amigos?</p></dt>
                        <dd>
                            <p>¡No solo puedes! ¡Queremos que lo hagas! Por esto, al invitar a 10 amigos, tendrás la oportunidad de ganarte otros 10 obsequios.</p>
                        </dd>
    ...
    <div class="container">
        <div class="row">
            <div class="span12">
                ...
                <a class="newsletter-btn" id="button-newsletter" href="#" title="Subscribe now">¡Inscríbete Ya!</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="span12">
                <h1 id="logo-footer">
                    <span class="logo-fontcon icon-magic"></span>
                    <img src="https://s3-us-west-2.amazonaws.com/com.nest5.assets/user-profile/letras_nest5_90x90.png" alt="Nest5" class="footer-logo">
                </h1>
                <p class="copyright">&copy; 2013. Nest5. Todos los derechos reservados. Nest5 es una Marca Registrada de <a href="http://www.qtagtech.com" target="_blank">Qtag Technologies S.A.S</a> .</p>
                <!-- GO TO TOP BUTTON -->
                <div id="totop"><a class="smoothscroll" href="#top"><img src="${resource(dir: 'landing/images',file: 'totop.png')}" alt="¡Inscríbete Ya!"></a></div>
            </div>
        </div>
    </div>
</footer>
...
<script src="${resource(dir: 'landing/js',file: 'bootstrap.min.js')}" type="text/javascript"></script><!-- Twitter Bootstrap core -->
