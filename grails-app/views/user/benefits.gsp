                ...
                <div class="span12">
                    <div class="well sidebar-nav">
                        <ul class="nav nav-list">
                            ...
                            <li class="active"><a href="${createLink(uri: '/user/benefits')}">Mis Beneficios</a></li>
                ...
                .then(function(response){
                    ...
                    if(totalLength > 0){
                        ...
                        while(i < totalLength){
                            ...
                            var image  =  "https://s3-us-west-2.amazonaws.com/com.nest5.assets/cards/estrella.jpg";
                            ...
                            html += '<li  class="span4">'
                                    ...
                                    +'<div class="caption">'
                                    +'<h3 style="word-wrap:break-word; line-height: 0.9em;">Redimible hasta:</h3>'
                                    +'<h5>'+response[i].redimible+'</h5>'
...
//                        $(".tool").popover({trigger: 'hover'});
    ...
    {
        var url = "${createLink(controller: 'user', action: 'requestUserCoupons')}";
